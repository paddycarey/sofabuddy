...
try:
    ...
    episode_number_regexes = [['s[0-9][0-9]e[0-9][0-9]', 1, 3, 4, 6], ['s[0-9]e[0-9][0-9]', 1, 2, 3, 5], ['s[0-9]e[0-9]', 1, 2, 3, 4], ['[0-9][0-9]x[0-9][0-9]', 0, 2, 3, 5], ['[0-9]x[0-9][0-9]', 0, 1, 2, 4], ['s[0-9][0-9] ep[0-9][0-9]', 1, 3, 6, 8]]
